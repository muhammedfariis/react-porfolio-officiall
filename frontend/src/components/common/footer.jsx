...
function Footer() {
  return (
    <div className=" items-center gap-5 backdrop-blur-3xl bg-linear-to-bl from-40% from-indigo-950 to-blue-950  shadow-gray-900 m-0 p-0">
      <div className="flex  items-center justify-between pr-5 pl-5 pt-3 h-50 ">
        <div>
          <img className="h-25 w-35 animate-bounce hover:scale-90" src="/public/images/logo.png" alt="" />
          <h1 className="max-w-md text-lg text-white">
        ...
        <div className="flex gap-2 flex-col justify-center items-center text-white  ">
          ...
          <div className="flex flex-col text-center text-white">
            <Link className="font-semibold text-lg hover:scale-95  transition duration-300  " to="/">Home</Link>
            <Link  className="font-semibold text-lg hover:scale-95 transition duration-300 "  to="/about">About</Link>
            <Link className="font-semibold text-lg hover:scale-95 transition duration-300  " to="/project">Project</Link>
            <Link className="font-semibold text-lg hover:scale-95  transition duration-300  " to="/contact">Contact</Link>
          </div> 
        </div>
        <div className="flex flex-col justify-center items-center gap-3">
          <h1 className="font-bold text-xl text-white">Connect</h1>
          <div className="flex gap-3">
            <a href="https://www.linkedin.com/jobs/muhammedfariis">
              <svg
                viewBox="0 0 24 24"
                fill="currentColor"
                class="w-8 h-8 rounded bg-gray-300 hover:scale-95  transition duration-300 "
              >
            ...
            <a href="https://github.com/muhammedfariis">
              <svg
                viewBox="0 0 24 24"
                fill="currentColor"
                class="w-8 h-8 text-white hover:scale-95  transition duration-300 "
              >
            ...
            <a href="https://www.instagram.com/?utm_source=pwa_homescreen&__pwa=1">
              <svg
                viewBox="0 0 24 24"
                fill="currentColor"
                class="w-8 h-8 text-white rounded hover:scale-95  transition duration-300 "
              >
         ...
         <div className="h-1 min-w-full bg-gray-400 mask-r-from-0% mask-l-from-0%  "></div>
           <p className="text-white">© 2026 Muhammed Faris. All Rights Reserved.</p>
         </div>
