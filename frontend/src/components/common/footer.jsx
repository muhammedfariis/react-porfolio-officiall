...
function Footer() {
  return (
    <div className=" items-center gap-5 backdrop-blur-3xl bg-linear-to-bl from-40% from-indigo-950 to-blue-950  shadow-gray-900 ">
      <div className="flex  items-center justify-between pr-5 pl-5 pt-3 h-50 ">
        ...
        <div className="flex flex-col justify-center items-center gap-3">
          ...
          <div className="flex gap-3">
            <a href="https://www.linkedin.com/jobs/muhammedfariis">
              <svg
                viewBox="0 0 24 24"
                fill="currentColor"
                class="w-8 h-8 border-2 rounded bg-gray-300 hover:scale-95  transition duration-300 "
              >
         ...
         <div className="h-1 min-w-full bg-black mask-r-from-0% mask-l-from-0%  "></div>
