...
const Contact = () => {
  ...
  return (
    <div className=" overflow-hidden relative min-h-screen items-center justify-center flex text-white border-blue-950 ">
      <video
      ...
      <div className="flex gap-3 p-5">
        <div className="flex flex-col justify-center items-center p-3 gap-3 backdrop-blur-3xl shadow-2xl bg-white/10 rounded-2xl ">
          ...
          <div className="flex flex-col w-full rounded h-full gap-3">
            <form
              className="flex flex-col w-full rounded h-full gap-3"
              onSubmit={submitForm}
            >
              <input
                onChange={(e) => setSubmit(e.target.value)}
                placeholder="Name"
                className="h-12 w-150  p-2 outline-none backdrop-blur-3xl shadow-2xl rounded-lg"
                required
                type="text"
              />
              <input
                onChange={(e) => setSubmit(e.target.value)}
                placeholder="Email"
                className="h-12 w-150 p-2 backdrop-blur-3xl outline-none shadow-2xl rounded-lg"
                required
                type="email"
              />
              <input
              ...
              <select
                ...
                className="h-12 p-1 w-150 outline-none backdrop-blur-3xl shadow-2xl rounded-lg"
                required
              >
              ...
              <textarea
                ...
                className="h-30 w-150 p-2 outline-none backdrop-blur-3xl shadow-2xl rounded-lg"
              ></textarea>
        ...
        <div className="flex flex-col gap-4 backdrop-blur-3xl shadow-2xl rounded-2xl h-fit p-5">
          <div className="flex justify-center items-center">
            <h1 className="font-bold text-2xl">Quick Contact</h1>
          </div>
          {/* email */}
          <div>
        ...
        <div className="flex flex-col gap-5 backdrop-blur-3xl shadow-2xl rounded-2xl h-fit p-5 ">
          <div className="flex justify-center items-center">
            <h1 className="font-bold text-2xl">Connect on Social Media</h1>
          </div>

          <div className="flex gap-4 w-full ">
            {/* div 1 */}
            <div className="flex flex-col gap-5 w-40">
              <div className="flex items-center w-60 gap-2 rounded-2xl ">
                <a href="https://github.com/muhammedfariis">
                  <svg
                    viewBox="0 0 24 24"
                    fill="currentColor"
                    class="w-8 h-8  hover:scale-95  transition duration-300 "
                  >
              ...
              <div className="flex items-center  gap-2 w-60 rounded-2xl ">
                <a href="https://www.linkedin.com/jobs/muhammedfariis">
                  <svg
                    viewBox="0 0 24 24"
                    fill="currentColor"
                    class="w-8 h-8 rounded hover:scale-95  transition duration-300 "
                  >
            ...
            <div className="flex flex-col gap-5 w-40">
              <div className="flex items-center  w-60 gap-1 rounded-2xl ">
            ...
            <div className="flex flex-col gap-5 w-40">
              <div className="flex items-center w-60 gap-2 rounded-2xl">
                <a href="https://www.facebook.com">
                  <svg
                    viewBox="0 0 24 24"
                    fill="currentColor"
                    className="w-8 h-8 hover:scale-95 transition duration-300"
                  >
                    <path d="M22.675 0h-21.35C.597 0 0 .597 0 1.326v21.348C0 23.403.597 24 1.326 24H12.82v-9.294H9.692V11.01h3.128V8.309c0-3.1 1.893-4.788 4.659-4.788 1.325 0 2.463.099 2.795.143v3.24h-1.918c-1.504 0-1.796.716-1.796 1.765v2.315h3.587l-.467 3.696h-3.12V24h6.116C23.403 24 24 23.403 24 22.674V1.326C24 .597 23.403 0 22.675 0z" />
                  </svg>
                </a>
              ...
              <div className="flex items-center w-60 gap-2 rounded-2xl">
                <a href="https://t.me/muhammedfaaris">
                  <svg
                    viewBox="0 0 24 24"
                    fill="currentColor"
                    className="w-8 h-8 hover:scale-95 transition duration-300"
                  >
                    <path d="M9.036 15.803l-.377 5.318c.54 0 .774-.232 1.053-.51l2.53-2.4 5.242 3.834c.962.53 1.648.252 1.905-.89l3.454-16.19c.316-1.47-.53-2.04-1.463-1.69L1.9 9.28c-1.42.55-1.398 1.34-.244 1.7l4.91 1.53L18.7 5.88c.57-.35 1.09-.16.66.19z" />
                  </svg>
                </a>
          ...
          {/* resume dowwnload */}
          <div className="flex backdrop-blur-3xl border-2 shadow-2xl w-130 h-fit p-5 justify-center rounded-2xl gap-2 flex-col items-center">
            <div className="flex items-center justify-center flex-col gap-2">
              <h1 className="text-2xl font-bold">Download Resume</h1>
              <div className="flex flex-col items-center">
                <p className="">Full-stack developer open to relocation</p>
                <p> you can download this PDF to view my resume.</p>
              </div>
            </div>
            <div>
              <Link to="/public/pdf/MuhammedFaris_resume.pdf"  target="_blank" download>
                <button className="w-100 h-10 text-lg font-bold bg-linear-to-bl from-yellow-400 border-2 border-gray-600 rounded-2xl transition duration-300 ease-in-out hover:scale-105">
                  Download
                </button>
              </Link>
            </div>
